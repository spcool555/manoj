...
const menuDataProductsRange = [
  ...
  submenu: [
...

    {
      ...
      links: [
        { title: "Bar to Bar", path: "products?category=btb",imageUrl:"https://www.raychemrpg.com/assets/images/gallery/XHvdxgPTvcZJyCvC3MAbQT1OdP3BWW.JPG" },
        { title: "Bar to Earth Rod", path: "products?category=bter", imageUrl:"https://www.raychemrpg.com/assets/images/products/K2qtzr9ErAUpMaXr8Ctwm9h6JqRDhT.JPG" },
        { title: "Bar to Steel Surface", path: "products?category=btss", imageUrl:"https://www.raychemrpg.com/assets/images/gallery/hEiamJIcg8ZErUlkB9iZpb29tu8cz2.JPG" },
        { title: "Cable to Bar", path: "products?category=ctb", imageUrl:"https://www.raychemrpg.com/assets/images/gallery/sHQt7MnCWHHOLmzrCCUYYwkK5arQGD.JPG" },
        { title: "Cable to Cable", path: "products?category=ctc", imageUrl:"https://www.nvent.com/sites/default/files/styles/product_and_sku_image_582x334_no_crop/public/acquiadam_assets/2022-05/PH37363.png.webp?itok=j9WjBI4N" },
        { title: "Cable to Earth Rod", path: "products?category=cter", imageUrl:"https://www.raychemrpg.com/assets/images/products/vRalD5mjtKf3D83U5gdblXUDIgE16q.JPG" },
        { title: "Cable to Rebar", path: "products?category=ctr", imageUrl:"https://www.raychemrpg.com/assets/images/products/QY3bQ2FTPNFZKI5evd11kqSdXrkC4S.JPG" },
        { title: "Cable to Steel Surface", path: "products?category=ctss", imageUrl:"https://www.raychemrpg.com/assets/images/products/W8kyfcyPKJqsjIkfEK3gGRtEzJfVVo.JPG" },
        { title: "Stud to Steel Surface", path: "products?category=stss", imageUrl:"https://kingsmillindustries.com/wp-content/uploads/2020/08/kingsweld-stud-to-vertical-steel-surface-connection-rs-1.jpg" },
        { title: "Welding Powders", path: "products?category=wp" , imageUrl:"https://norrscope.com/wp-content/uploads/2024/09/furseweld-powder.png"},
      ],
    },
...
const ExothermicWelding = () => {

    const usePathName = usePathname();    

    const productMenu = menuDataProductsRange[0].submenu;

  const groundingMenu = productMenu.find((item) => item.title === "Exothermik Welding");
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Exothermic Welding
    </h1>
  </div>
</div>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Conductors</h3>
                       ...
                       <Link href="/surge-protection" className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                   
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Surge Protection</h3>
                </Link>
...
export default ExothermicWelding
;
