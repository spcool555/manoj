...
const menuDataProductsRange = [
  ...
  submenu: [
...

    {
      ...
      links: [
        { title: "Air Rods", path: "/products?category=airrods", imageUrl:"https://www.hexworldwide.com/wp-content/uploads/2022/01/AERIAL-ROD-TERMINAL-BASE-New-1-300x261.jpg" },
        { title: "Lightning Protection Clamps", path: "/products?category=LightningProtectionClamps", imageUrl:"https://www.ingesco.com/sites/default/files/styles/productos_800x800/public/productos/abrazadera_ligera_conductor_plano_0.jpg?width=800&height=800&slideshow=true&slideshowAuto=false&slideshowSpeed=3000&transition=elastic&speed=350" },
...
const LightningProtection = () => {
  ...
  const groundingMenu = productMenu.find((item) => item.title === "Lightning Protection");
  const otherMenus = productMenu.filter((item) => item.title !== "Lightning Protection");
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Lightning Protection</h1>
  </div>
</div>
