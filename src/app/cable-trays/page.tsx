...
const menuDataProductsRange = [
  ...
  submenu: [
...

    {
      title: "Cable Trays",
      links: [
        { title: "Perforated Cable Trays", path: "products?category=pct", imageUrl:"https://5.imimg.com/data5/SELLER/Default/2021/3/TR/BV/KP/12015665/gi-perforated-cable-trays-100-x-50-500x500.jpg" },
        { title: "Ladder Type Cable Trays", path: "products?category=ltct", imageUrl:"https://d91ztqmtx7u1k.cloudfront.net/ClientContent/Images/ExtraLarge/20220620054858-f477f07f-f715-44fc-9673-0eee11cb1bee.jpg" },
        { title: "Trunking Cable Trays", path: "products?category=tct", imageUrl:"https://www.cabletraychina.com/wp-content/uploads/2018/05/custom-galvanised-metal-trunking-500x375.jpg" },
        { title: "Raceways Cable Tray", path: "products?category=rct", imageUrl:"https://cpimg.tistatic.com/09311106/b/4/Gi-Raceway-Cable-Tray.jpg" },
        { title: "Wire Mesh Cable Trays", path: "products?category=wmct" , imageUrl:"https://content.jdmagicbox.com/rep/b2b/weld-mesh-cable-tray/weld-mesh-cable-tray-1.jpg?impolicy=queryparam&im=Resize=(360,360),aspect=fit"},
        { title: "Non-Mettalic Cable Trays", path: "products?category=nmct", imageUrl:"https://image.made-in-china.com/202f0j00DSPVuvIlfJko/Non-Metallic-Telecom-Cable-Ladder-Tray-From-Polymer-Whisker-Composite.webp" },
...
const CableTrays = () => {
  ...
  const groundingMenu = productMenu.find((item) => item.title === "Cable Trays");
  const otherMenus = productMenu.filter((item) => item.title !== "Cable Trays");
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Cable Trays</h1>
  </div>
</div>
