...
const Grounding = () => {
  ...
  const groundingMenu = productMenu.find((item) => item.title === "Grounding");
  const otherMenus = productMenu.filter((item) => item.title !== "Grounding");
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Grounding</h1>
  </div>
</div>
