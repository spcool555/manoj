...
const menuDataProductsRange = [
  ...
  submenu: [
   ...
   
    {
      ...
      links: [
        { title: " Security Fixings", path: "products?category=sf", imageUrl:"https://searlefasteners.com.au/wp-content/uploads/2016/09/Security-Srews-For-Prisons-Hospitals-Military-1-1-e1498199864358.jpg" },
        { title: "Hexagon Head Set Screws", path: "/products?category=hhsc", imageUrl:"https://m.media-amazon.com/images/I/51GwF0hRz8L._AC_UF1000,1000_QL80_.jpg" },
        { title: "Hexagon Nuts", path: "products?category=hn", imageUrl:"https://m.media-amazon.com/images/I/61uXhPZbLZL._AC_UF1000,1000_QL80_.jpg" },
        { title: "Spring Washers", path: "products?category=sw", imageUrl:"https://www.pankajinternational.com/PankajInternationalmages/ProductImages/washers-washers-spring-lock-washer-3-PankajInternational.jpg" },
        { title: "Countersunk Wood Screw", path: "products?category=cws" , imageUrl:"https://s3-eu-west-1.amazonaws.com/firstlightingimages/product-images/1000-1000/29bWoodScrewZinc&YellowFullThreadO6.jpg"},
        { title: "Tinned Copper Tapes", path: "products?category=tct", imageUrl:"https://5.imimg.com/data5/SELLER/Default/2024/2/385869289/GN/ZZ/UL/78265995/tinned-copper-tapes.jpg" },
        { title: "Round Head Wood Screws", path: "products?category=rhws", imageUrl:"https://m.media-amazon.com/images/I/61cfunJKs3L._SX522_.jpg" },
        { title: "Rail", path: "products?category=rail" , imageUrl:"https://rail-track.com/wp-content/uploads/QQ%E5%9B%BE%E7%89%8720220524140539-e1653375389526.png"},
        { title: "Plastic Wall Plugs", path: "products?category=pwp", imageUrl:"https://5.imimg.com/data5/RH/BE/MY-3993995/plastic-wall-plug-500x500.jpg" },
      ],
    },
  ],
},
...
const FastnersFixings = () => {

    const usePathName = usePathname();    

    const productMenu = menuDataProductsRange[0].submenu;

  const groundingMenu = productMenu.find((item) => item.title === "Fastners & Fixings");
  const otherMenus = productMenu.filter((item) => item.title !== "Fastners & Fixings");
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Fastners & Fixings</h1>
  </div>
</div>
...
export default FastnersFixings;
