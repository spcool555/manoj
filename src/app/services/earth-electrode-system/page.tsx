...
export const metadata: Metadata = {
  title: "EarthElectrodeSystem",
  description: "",
  // other metadata
};

const EarthElectrodeSystem = () => {
  return (
    <>
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Earth Electrode Systems</h1>
  </div>
</div>
...
export default EarthElectrodeSystem;
