...
const Conductors = () => {
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center py-24">
    <h1 className="text-5xl font-bold leading-tight mb-4">Conductors</h1>
  </div>
</div>
...
<div className=" container items-center grid-cols-2 mx-auto overflow-x-hidden lg:grid md:py-14" data-aos="fade-right" data-aos-duration="800">
          <div className="pr-2 md:mb-1 pt-24 md:py-0">
            <h1 className="font-semibold text-[#f9b800] text-2xl  xl:text-5xl lg:text-3xl">Experience Innovation & Reliability with MATCO</h1>
...
{/* <center className="mt-16">
                ...
                <div className="space-y-8">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <h1 className="text-3xl  xl:text-5xl lg:text-4xl font-bold tracking-tight text-black sm:text-5xl md:text-6xl">
  ...
  International standards.</p>
            ...
            <div className="hidden lg:block xl:block  items-center w-full col-span-6">
